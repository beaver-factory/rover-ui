...
export const fetchPhotos = async (rover: string, date: string, camera?: string): Promise<RoverPhoto[]> => {
    const response = await marsApi.get(`/rovers/curiosity/photos?earth_date=2023-2-3&api_key=${apiKey}`)
